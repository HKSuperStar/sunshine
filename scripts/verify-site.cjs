...
assert.equal(all.length,26,'8 pages + 2 case studies + 3 articles, each in two languages');
...
console.log('PASS: 26 independent bilingual pages, navigation, local assets and links, 14 industries, no environment file in deployment output.');
