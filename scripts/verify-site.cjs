...
assert.equal(all.length,20,'7 pages + 3 articles, each in two languages');
...
console.log('PASS: 20 independent bilingual pages, navigation, local assets and links, 14 industries, no environment file in deployment output.');
