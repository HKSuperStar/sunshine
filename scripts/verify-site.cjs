...
assert.equal(all.length,30,'8 pages + 4 case studies + 3 articles, each in two languages');
...
console.log('PASS: 30 independent bilingual pages, navigation, hreflang pairs, four case studies per language each with one illustration and no undefined field, local assets and links, 14 industries, no environment file in deployment output.');
